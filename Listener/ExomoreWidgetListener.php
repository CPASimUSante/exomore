...
namespace CPASimUSante\ExomoreBundle\Listener;
...
class ExomoreWidgetListener
{
    ...
    public function onDisplay(DisplayWidgetEvent $event)
    {
        ...
        $params = array();
        $params['_controller'] = 'CPASimUSanteExomoreBundle:ExomoreWidget:userStatDisplay';
    ...
    public function onConfigure(ConfigureWidgetEvent $event)
    {
        $widgetInstance = $event->getInstance();
        $params = array();
        $params['_controller'] = 'CPASimUSanteExomoreBundle:ExomoreWidget:userStatWidgetConfigureForm';
        $params['widgetInstance'] = $widgetInstance->getId();
        $this->redirect($params, $event);
    }
